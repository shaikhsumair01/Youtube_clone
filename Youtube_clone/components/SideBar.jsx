     ...
     <h1 className="Title"> Streamly</h1>
      ...
      <nav className="side_nav">
        <ul className="sidebar-links">
          <li className={`sidebar-link ${category===0?"shadow-md shadow-cyan-700/50":""}`} onClick={()=> {setCategory(0); onToggle()}}>
          ...
          <li className={`sidebar-link ${category===22?"shadow-md shadow-cyan-700/50":""}`} onClick={()=> {setCategory(22); onToggle()}}>
            <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
      ...
      <nav className="side_nav">
        ...
        <ul className="sidebar-links">
          <li className={`sidebar-link ${category===20?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(20); onToggle()}}>
            <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
            <i className="fa-solid fa-gamepad sidebar-link-icons"></i>
            <p className="sidebar-link-text">Gaming</p>
            </Link>
          </li>
          <li className={`sidebar-link ${category===2?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(2); onToggle()}}>
             <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
            <i className="fa-solid fa-car-side sidebar-link-icons"></i>
            <p className="sidebar-link-text">Automobiles</p>
            </Link>
          </li>
          <li className={`sidebar-link ${category===17?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(17);onToggle()}}>
           <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
            <i className="fa-solid fa-volleyball sidebar-link-icons"></i>
            <p className="sidebar-link-text">Sports</p>
            </Link>
          </li>
          <li className={`sidebar-link ${category===25?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(25);onToggle()}}>
           <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
            <i className="fa-solid fa-newspaper sidebar-link-icons"></i>
            <p className="sidebar-link-text">News</p>
            </Link>
          </li>
          <li className={`sidebar-link ${category===24?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(24);onToggle()}}>
            <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
            <i className="fa-solid fa-tv sidebar-link-icons"></i>
            <p className="sidebar-link-text">Entertainment</p>
            </Link>
          </li>
          <li className={`sidebar-link ${category===1?"shadow-md shadow-cyan-700/50":""}`} onClick={()=>{setCategory(1);onToggle()}}>
            <Link to = "/" className="flex items-center gap-3 w-full ml-[-2px]">
